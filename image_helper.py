...
def region_of_interest(img):
	...
	"""    
	shape = img.shape
	vertices = np.array([[(0,0),(shape[1],0),(shape[1],0),(6*shape[1]/7,shape[0]),(shape[1]/7,shape[0]), (0,0)]],dtype=np.int32)
...
def calculate_curvature(image, leftx, lefty, rightx, righty):
	"""
...
def draw_lanes(image, binary_warped_image, left_fit, right_fit, ploty, Minv):
	"""
